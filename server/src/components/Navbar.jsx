...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-6'>
        <Link to='/' className='max-md:flex-1'>
        <img src={assets.logo} alt="" className='w-26 h-auto' />
        </Link>
