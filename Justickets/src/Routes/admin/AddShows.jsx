    ...
    return nowPlayingMovies.length > 0 ? (
        <>
            ...
            <div className='overflow-x-auto pb-4'>
                <div className='group flex flex-wrap gap-4 mt-4 w-max'>
                    {nowPlayingMovies.map((movie) => (
                        <div key={movie.id} className='relative max-w-40 cursor-pointer group-hover:not-hover:opacit-40 hover:-translate-y-1 transition duration-300'
                            onClick={() => setSelectedMovie(movie.id)}>
                            <div className='relative rounded-lg overflow-hidden'>
                                <img src={image_base_url + movie.poster_path} alt="movie_poster" className='w-full object-cover brightness-90' />
            ...
            <div className='mt-8'>
                ...
                <div className='inline-flex items-center gap-5 border border-gray-600 py-1 pl-3 rounded-lg'>
